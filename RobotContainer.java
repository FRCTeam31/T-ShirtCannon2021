...
public class RobotContainer {
  ...
  private static WPI_TalonSRX l1,l2, r1,r2;
  ...
  public RobotContainer() {
    ...
    c = new Compressor(Constants.module_number);
    c.start();
    ...
    leftValve = new Solenoid(Constants.module_number, Constants.v_left);
    System.out.println("LEFT----------------------------------------------------------------");
    System.out.println("MID----------------------------------------------------------------");
    middleValve = new Solenoid(Constants.module_number ,Constants.v_middle);
    System.out.println("MID----------------------------------------------------------------");
    System.out.println("RIGHT----------------------------------------------------------------");

    rightValve = new Solenoid(Constants.module_number, Constants.v_right);
    System.out.println("RIGHT----------------------------------------------------------------");
